...
namespace Trident.Web.BusinessLogic.Syncers
{
    ...
    {
         Task ProcessProjects(SyncJobCompositeModel syncJobCompositeModel, SpaceModel space, CancellationToken stoppingToken);
    }
    ...
    public class ProjectSyncer : IProjectSyncer
    {
        ...
        public async Task ProcessProjects(SyncJobCompositeModel syncJobCompositeModel, SpaceModel space, CancellationToken stoppingToken)
        {
